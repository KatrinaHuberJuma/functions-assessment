...
def total_meal_price(price, tip=15.00/100):
...
def print_sign_and_parity(num):
    parity, sign = sign_and_parity(num)
    print sign
    print parity
...
def write_letter(recipient, recipient_title, sender_name):
    print "Dear {}, I think you are amazing! Sincerely, {}".format(full_title(recipient, recipient_title), sender_name)
